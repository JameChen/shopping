 ...
 * 2017/7/6 13:06
 */
public class PinWave extends View {
	...
	private int color;
	private String text = "拼";
	private int textSize = DimentionUtils.sp2px(getContext(), 25);

	public PinWave(Context context) {
		this(context, null);
	}

	public PinWave(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PinWave(Context context, AttributeSet attrs, int defStyleAttr) {
