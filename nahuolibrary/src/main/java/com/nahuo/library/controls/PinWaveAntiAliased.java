 ...
 *
 */
public class PinWaveAntiAliased extends View {
	...
	public PinWaveAntiAliased(Context context) {
		this(context, null);
	}

	public PinWaveAntiAliased(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PinWaveAntiAliased(Context context, AttributeSet attrs, int defStyleAttr) {
