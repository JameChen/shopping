...
import static com.nahuo.quicksale.CommonSearchActivity.EXTRA_SEARCH_TYPE;

public class SortReasonActivity extends BaseAppCompatActivity implements PinHuoShowAdapter.TitleSortMenusLister, OnClickListener, HttpRequestListener {
    public static final String TAG = SortReasonActivity.class.getSimpleName();
    public static final String EXTRA_SEARCH_KEY = "EXTRA_SEARCH_KEY";
    private Context mContext = this;
    public static final String EXTRA_RID = "EXTRA_RID";
    public static final String EXTRA_VALUEIDS = "EXTRA_VALUEIDS";
    public static final String EXTRA_TITLE = "EXTRA_TITLE";
    private RecyclerView mRecyclerView;
    // private TextView load_more_no_data_txt;
    private PinHuoShowAdapter mNewItemAdapter;
    // private Bookends1<PinHuoDetailAdapter> mNewItemBookends;
    ...
    // private PinHuoNestedScrollView scrollView;
    private Drawable nav_choose_sel, nav_choose;
    private boolean is_First_Sort = true;
    private boolean is_NewFirst_Sort = true, is_PassFirst_Sort = true;
    ...
    private String endStr = "亲已经加载完款式了";
    ...
    private List<SortMenusBean> sortNewMenus = new ArrayList<>();
    private List<SortMenusBean> sortPassMenus = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sort_reason_item);
    ...
    private void initView() {
        ...
        TextView txt_empty = (TextView) findViewById(R.id.empty_txt);
...
//        scrollView = (PinHuoNestedScrollView) findViewById(R.id.scrollView);
...
//        scrollView.setImgeViewOnClickListener((ImageView) findViewById(R.id.iv_scroll_to_top));
        ...
        TextView tv_title = (TextView) findViewById(R.id.tvTitleCenter);
...
//        load_more_no_data_txt = (TextView) findViewById(load_more_no_data_txt);
//        load_more_no_data_txt.setVisibility(View.GONE);
...
//                2, GridLayoutManager.VERTICAL, false));
        ...
        // mNewItemBookends = new Bookends1(mNewItemAdapter, gridManager);
        ...
        // WrapRecyclerAdapter wrapRecyclerAdapter=new WrapRecyclerAdapter(mNewItemAdapter);
        // mNewItemBookends.addFooter(footerView);
        // mAdapter = new RecyclerAdapterWithHF(mNewItemAdapter);
        // mRecyclerView.addFooterView(footerView);
        //   mNewItemAdapter.addHeaderView(footerView);
        ...
        mNewItemAdapter.setmListener(new PinHuoShowAdapter.PinHuoListener() {
            ...
            public void onNewOlderItemClick(ShopItemListModel item) {
                Intent intent = new Intent(SortReasonActivity.this, ItemDetailsActivity.class);
...
//        });
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            int mScrollThreshold = ScreenUtils.px2dip(SortReasonActivity.this, 30);
...
//                Log.d("yu","dy==>"+dy);
//                Log.d("yu","Math.abs(dy)==>"+Math.abs(dy));
                ...
                int pos = ((GridLayoutManager) mRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
               ...
               // Log.e("yu", pos + "====sortPos=" + sortPos + "isScrollPassSort=" + isScrollPassSort);
//                int scroll_height = ScreenUtils.px2dip(SortReasonActivity.this,-10);
//                int scroll_down_height =ScreenUtils.px2dip(SortReasonActivity.this,10);
////                int pos = ((GridLayoutManager) mRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
////                if (pos >= 0) {
//                   // if (getScollYDistance() > ScreenUtils.px2dip(SortReasonActivity.this,40)) {
//                        if (dy < scroll_height) {
//                            if (!isGbHide)
//                                radio_group_head.setVisibility(View.VISIBLE);
//                        } else {
    ...
    private void initDrawView() {
        ...
        mDrawerLayout.setDrawerListener(new DrawerLayout.DrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                FunctionHelper.hideSoftInput(SortReasonActivity.this);
...
//                startActivity(cIntent);
            ...
            case R.id.img_Tsearch:
                ...
                intent.putExtra(EXTRA_SEARCH_TYPE, CommonSearchActivity.SearchType.ALL_ITEM_SEARCH);
...
//                        public void onClick(View v) {
//                            mCrrentPos = pos;
//                            setItemOnclick(mTvs, pos, sortMenus, nav_nomal, nav_choose, nav_up, nav_dowm);
//                        }
//                    });
//
//                }
...
//    }
    ...
    private void getSearchPanel() {
        try {
            ...
            //QuickSaleApi.getSearchPanel(this, mRequestHelper, this, IDsConstant.AREAID_SORT + "", jsonobject.toString());
            addSubscribe(HttpManager.getInstance().getPinHuoNoCacheApi(TAG)
                    .getSearchPanel(IDsConstant.AREAID_SORT, jsonobject.toString(), displaystatuid)
