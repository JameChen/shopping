 ...
 */
public class DetailsSingleSharePopWindow extends BaseActivty implements OnItemClickListener, IWeiboHandler.Response, OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_share_link:
                Share_Type = 1;
                tv_share_link.setTextColor(ContextCompat.getColor(DetailsSingleSharePopWindow.this, R.color.base_red));
                tv_share_pics.setTextColor(ContextCompat.getColor(DetailsSingleSharePopWindow.this, R.color.black));
                tv_share_link.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsSingleSharePopWindow.this, R.drawable.icon_dl));
                tv_share_pics.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsSingleSharePopWindow.this, R.drawable.icon_dlk));
            ...
            case R.id.tv_share_pics:
                Share_Type = 2;
                tv_share_pics.setTextColor(ContextCompat.getColor(DetailsSingleSharePopWindow.this, R.color.base_red));
                tv_share_link.setTextColor(ContextCompat.getColor(DetailsSingleSharePopWindow.this, R.color.black));
                tv_bottom.setVisibility(View.VISIBLE);
