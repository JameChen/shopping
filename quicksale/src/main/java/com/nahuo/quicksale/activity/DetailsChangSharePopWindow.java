 ...
 */
public class DetailsChangSharePopWindow extends BaseActivty implements OnItemClickListener, IWeiboHandler.Response, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popup_share3);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_share_link:
                Share_Type = 1;
                tv_share_link.setTextColor(ContextCompat.getColor(DetailsChangSharePopWindow.this, R.color.base_red));
                tv_share_pics.setTextColor(ContextCompat.getColor(DetailsChangSharePopWindow.this, R.color.black));
                tv_share_link.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsChangSharePopWindow.this, R.drawable.icon_dl));
                tv_share_pics.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsChangSharePopWindow.this, R.drawable.icon_dlk));
            ...
            case R.id.tv_share_pics:
                Share_Type = 2;
                tv_share_pics.setTextColor(ContextCompat.getColor(DetailsChangSharePopWindow.this, R.color.base_red));
                tv_share_link.setTextColor(ContextCompat.getColor(DetailsChangSharePopWindow.this, R.color.black));
                tv_bottom.setVisibility(View.VISIBLE);
                mGridView.setVisibility(View.GONE);
                ll_bom.setVisibility(View.VISIBLE);
             //   tv_share_link.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsSingleSharePopWindow.this, R.drawable.icon_dlk));
              //  tv_share_pics.setCompoundDrawablesWithIntrinsicBounds(null, null, null, ContextCompat.getDrawable(DetailsSingleSharePopWindow.this, R.drawable.icon_dl));
                break;
...
//                }
                mShareHelper.share(NahuoShare.PLATFORM_WX_FRIEND, mShareData);
                finish();
                break;
...
//                            BusEvent.getEvent(EventBusId.SHARE_WEIXIN_PICS, bean));
//                }
                mShareHelper.share(NahuoShare.PLATFORM_WX_CIRCLE, mShareData);
                finish();
                break;
