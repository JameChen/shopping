...
import com.nahuo.quicksale.hyphenate.ui.EaseShowNormalFileActivity;
import com.nahuo.quicksale.hyphenate.widget.chatrow.EaseChatRow;
import com.nahuo.quicksale.hyphenate.widget.chatrow.EaseChatRowFile;
...
public class EaseChatFilePresenter extends EaseChatRowPresenter {
    ...
    public void onBubbleClick(EMMessage message) {
        ...
        if (file.exists()) {
            ...
            FunctionHelper.openFile(file, (Activity) getContext());
        } else {
            // download the file
