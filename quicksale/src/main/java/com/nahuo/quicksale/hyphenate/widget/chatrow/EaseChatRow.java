...
import com.nahuo.quicksale.hyphenate.adpater.EaseMessageAdapter;
...
import com.nahuo.quicksale.hyphenate.widget.EaseChatMessageList.MessageListItemClickListener;
import com.nahuo.quicksale.hyphenate.widget.EaseImageView;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        onInflateView();
        iv_shop = (ImageView) findViewById(R.id.icon_shop);
    ...
    private void setUpBaseView() {
        ...
        if (userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                EaseUserUtils.setPinHuoUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView, ChatUtl.TYPE_ME);
            } else {
                EaseUserUtils.setPinHuoUserAvatar(context, message.getFrom(), userAvatarView, ChatUtl.TYPE_TO);
