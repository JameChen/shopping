...
import com.nahuo.quicksale.hyphenate.widget.EaseChatVoiceCallPresenter;
...
public class ChatFragment extends com.nahuo.quicksale.hyphenate.ui.EaseChatFragment implements EaseChatFragment.EaseChatFragmentHelper {
    ...
    private static final int ITEM_SHOP = 17;
...
//                                putExtra("groupId", toChatUsername), REQUEST_CODE_SELECT_AT_USER);
    ...
    protected void registerExtendMenuItem() {
        ...
        //extend menu items
        if (mSendItem != null) {
            inputMenu.registerExtendMenuItem(R.string.attach_shop, R.drawable.chat_item_normal, ITEM_SHOP, extendMenuItemClickListener);
        }
...
//        startActivity(intent);
    ...
    public boolean onMessageBubbleClick(EMMessage message) {
        ...
        if (ChatUtl.isItemMessage(message)) {
            ShopItemModel shopItemModel =ChatUtl. getItemMessage(message);
            if (shopItemModel != null) {
                Intent gotoItemIntent = new Intent(getActivity(), ItemDetailsActivity.class);
                gotoItemIntent.putExtra(ItemDetailsActivity.EXTRA_ID, shopItemModel.ID);
                getActivity().startActivity(gotoItemIntent);
            }
