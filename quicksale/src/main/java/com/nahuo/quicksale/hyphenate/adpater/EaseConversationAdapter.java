...
import com.nahuo.quicksale.hyphenate.widget.EaseConversationList.EaseConversationListHelper;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (username.equals(ChatUtl.SYSTEM_HX_ID + "")) {
                ...
                name = ChatUtl.SYSTEM_NAME;
            } else {
                imageurl = SpManager.getECC_HEADIMAGE(getContext());
                name = SpManager.getECC_USER_NAME(getContext())+ChatUtl.ECC_KEFU_DEP;
            }
            RequestOptions options = new RequestOptions();
            options.diskCacheStrategy(DiskCacheStrategy.ALL)
                    .placeholder(R.drawable.ease_default_avatar);
            Glide.with(getContext()).load(imageurl).apply(options).into(holder.avatar);
        ...
        if (conversation.getAllMsgCount() != 0) {
            ...
            if (ChatUtl.isItemMessage(lastMessage)) {
