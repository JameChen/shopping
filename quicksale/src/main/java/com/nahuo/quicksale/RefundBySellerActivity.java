 ...
 * 卖家退款详细
 */
public class RefundBySellerActivity extends BaseSlideBackActivity implements OnClickListener {
    ...
    private RefundBySellerActivity vThis     = this;
    ...
    private class Task extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... arg0) {
            ...
            try {
                switch (mStep) {
                    case LOAD_INFO:
                        mBill = OrderAPI.getrundbyseller(vThis, mId, 2);
                        return mBill;
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result instanceof String && ((String)result).startsWith("error:")) {
                ...
                switch (mStep) {
                    case LOAD_INFO:
                        RefundinfoBySellerFragment frag = RefundinfoBySellerFragment
