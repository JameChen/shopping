...
public class Bookends1<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public Bookends1(T base) {
        super();
        mBase = base;
    }

    public Bookends1(T base, final GridLayoutManager gridLayoutManager) {
        this(base);
...
//                }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
       // Log.e("yu", "pos===" + position + "mHeaders.size()" + mHeaders.size() + "mBase.getItemCount()" + mBase.getItemCount());
        if (viewHolder instanceof Bookends1.HolderType) {
           // Log.e("yu", "==aaaaaaaaa");
        ...
        } else if (!(viewHolder instanceof Bookends1.HolderType) && (position < mHeaders.size() + mBase.getItemCount())) {
