 ...
 */
public class MyGoodsAdapter extends MyBaseAdapter<ShopItemListModel> implements OnClickListener {
...
//    private static final String TAG_COLLAPSE = "收起";
    ...
    public MyGoodsAdapter(FragmentActivity context) {
        super(context);
//        MAX_LINE = context.getResources().getInteger(R.integer.content_max_line);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.lvitem_my_goods, parent, false);
            ...
            //   holder.mIvCollection = (ImageView) convertView.findViewById(R.id.Iv_Collection);
            ...
            holder.mHideView = (LinearLayout) convertView.findViewById(R.id.hid_opview);
...
//        });
        ...
        holder.mTime.setText(listItem.getCreateDate());
        ...
        if (!listItem.isStart()) {
            ...
            if (listItem.getChengTuanCount() > listItem.getDealCount()) {
                holder.mBar.setProgressDrawable(mContext.getResources().getDrawable(R.drawable.style_progressbar_nostatus));
            } else {
                holder.mBar.setProgressDrawable(mContext.getResources().getDrawable(R.drawable.style_progressbar));
            }
        } else {
            //未结束
            holder.mHideView.setVisibility(View.GONE);
