...
public class IntoGroupAdapter extends RecyclerView.Adapter<ViewHolder> {
    private Context context;
    private Activity activity;
    private int mGridViewWidth;
    private IntoGroupAdapter.Listener mListener;
    private IntoGroupAdapter.IBuyClickListener mIBuyClickListener;
    ...
    public IntoGroupAdapter(Context context) {
...
//                }
    ...
    public void setListener(IntoGroupAdapter.Listener listener) {
        mListener = listener;
    }

    public void setIBuyClickListener(IntoGroupAdapter.IBuyClickListener listener) {
