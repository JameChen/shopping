package com.nahuo.quicksale.tabfragment.yepin;
 ...
 * @author nahuo9
 */
public class YePinTabFragment extends TabFragment implements View.OnClickListener, PullToRefreshListView.OnLoadMoreListener, PullToRefreshListView.OnRefreshListener {

    private static final String TAG = YePinTabFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.activity_yepin, container, false);
        vThis = getActivity();
        groupID = Const.YEPIN_GROUPID;
