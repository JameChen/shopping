 ...
 * 买家退款详细
 */
public class RefundByBuyerActivity extends BaseSlideBackActivity implements OnClickListener {
    ...
    private RefundByBuyerActivity  vThis     = this;
    ...
    private class Task extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... arg0) {
            ...
            try {
                switch (mStep) {
                    case LOAD_INFO:
                        mBill = OrderAPI.getrundbybuyer(vThis, mId, 2);
                        return mBill;
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result instanceof String && ((String)result).startsWith("error:")) {
                ...
                switch (mStep) {
                    case LOAD_INFO:
                        RefundinfoByBuyerFragment frag = RefundinfoByBuyerFragment
                                .newInstance((RefundPickingBillModel)result);

                        FragmentTransaction transaction = getFragmentManager().beginTransaction();
                        transaction.replace(R.id.frame_refund, frag);
