 ...
 * @author JorsonWong
 */
public class HttpRequestHelper1 {
    ...
    public HttpRequest getRequest(Context context, String method, HttpRequestListener1 requestListener) {
...
public void cancelRequests() {
    ...
    public static class HttpRequest {
        ...
        private HttpRequestListener1 mHttpRequestListener;
         ...
         */
        public HttpRequest(Context context, String method, AsyncHttpClient client, HttpRequestListener1 requestListener) {
        ...
        public void doPost() {
            if (!isNetworkAvailable(mContext)) {// 无网络
                if (mHttpRequestListener != null) {
                    ...
                    mHttpRequestListener.onRequestFail1(mMethod, 0, mContext.getString(R.string.connect_failuer_toast));
                }
                return;
            }
            ...
            final String url = mServer + mMethod;
            ...
            mClient.post(url, requestParams, new JsonHttpResponseHandler() {
                ...
                public void onStart() {
                    ...
                    if (mHttpRequestListener != null) {// callback
                        mHttpRequestListener.onRequestStart1(mMethod);
                    }
                    super.onStart();
                }
                ...
                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                    ...
                    if (mHttpRequestListener != null) {// callback
                        mHttpRequestListener.onRequestFail1(mMethod, statusCode, responseString);
                    }
                ...
                public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                    ...
                    if (mHttpRequestListener != null) {// callback
                        mHttpRequestListener.onRequestFail1(mMethod, statusCode, throwable.getMessage());
                    }
        ...
        private void dealResultData(Header[] headers, Object data) {
            ...
            if (mHttpRequestListener != null)
                mHttpRequestListener.onRequestSuccess1(mMethod, obj);
        }
            ...
            try {
                ...
                if (result) {// 服务端请求正确
                    ...
                    if (data != null) {
                        ...
                        if (mHttpRequestListener != null) {
                            mHttpRequestListener.onRequestSuccess1(mMethod, resultData);
                        }
                    }
...
//                        ViewHub.showShortToast(mContext, resultData.getMessage());
                        mHttpRequestListener.onRequestExp1(mMethod, resultData.getMessage(), resultData);
                    }
                }
            } catch (Exception e) {
                ...
                e.printStackTrace();
                if (mHttpRequestListener != null) {
                    mHttpRequestListener.onRequestExp1(mMethod, e.toString(), null);
                }
            }
        }
