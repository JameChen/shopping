...
//      String VISIBLE = this.getIntent().getStringExtra("VISIBLE");
//      if((!TextUtils.isEmpty(VISIBLE))&&VISIBLE.equals(VISIBLE)){
//        findViewById(R.id.tv_copy).setVisibility(View.GONE);
//        findViewById(R.id.tv_copy_user).setVisibility(View.VISIBLE);
//      }
//    } /*
...
//     * EMMessage.Type.LOCATION.ordinal(): setContentView(R.layout.context_menu_for_location); break;
//     * case EMMessage.Type.IMAGE.ordinal(): setContentView(R.layout.context_menu_for_image); break;
//     * case EMMessage.Type.VOICE.ordinal(): setContentView(R.layout.context_menu_for_voice); break;
//     * //need to support netdisk and send netsdk? case Message.TYPE_NETDISK:
//     * setContentView(R.layout.context_menu_for_netdisk); break; case Message.TYPE_SENT_NETDISK:
//     * setContentView(R.layout.context_menu_for_sent_netdisk); break; default: break; }
//     */
