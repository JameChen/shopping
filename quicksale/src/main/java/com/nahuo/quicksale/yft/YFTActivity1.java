...
public class YFTActivity1 extends BaseSlideBackActivity {

    private static final String TAG = YFTActivity1.class.getSimpleName();
    private LoadingDialog mDialog;
    private static final int POS_SET_SAFEQ = 2;
    private static final int POS_PAY_PSW = 0;
    private static final int POS_BINDPHONE = 1;
    private static final int POS_AGREEMENT = 11;
    private static final int POS_INIT_FRAGMENT = 12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isYftOpened()&&HasPayPassword>0) {
            createOpenedView();
        } else {
            createNotOpenedView();
        }
...
//        initTitleBar();
        ...
        intent.putExtra(FogetPayPassWordActivity.EXTRA_NEED_OPEN_YFT,true);
