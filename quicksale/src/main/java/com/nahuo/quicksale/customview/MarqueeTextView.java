...
//        xOffset = 0;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        contentColor = array.getColor(R.styleable.MarqueeTextView_content_text_color, Color.WHITE);
...
//        Logger.e("contentTextSize=" + contentTextSize);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY && heightMode == MeasureSpec.EXACTLY) {
            ...
            setMeasuredDimension(widthSize, maxContentHeight+10);
        } else if (heightMode == MeasureSpec.EXACTLY) {
            setMeasuredDimension(maxContentWidth, heightSize);
        } else {
            setMeasuredDimension(maxContentWidth, maxContentHeight+10);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (listener != null) {
                    listener.onItemclick(currnetIndex);
                }
                // invalidate();
                break;
