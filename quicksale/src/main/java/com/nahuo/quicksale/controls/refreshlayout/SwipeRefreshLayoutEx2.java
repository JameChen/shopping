 ...
 */
public class SwipeRefreshLayoutEx2 extends SwipeRefreshLayout implements IRefreshLayout {
    ...
    public SwipeRefreshLayoutEx2(Context context) {
        super(context);
        init(context);
    }

    public SwipeRefreshLayoutEx2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void handleChildView() {
        ...
        if (mChildView instanceof PinHuoNestedScrollView) {
            final PinHuoNestedScrollView sv= (PinHuoNestedScrollView) mChildView;
    ...
    private void canScrollDown(View view, boolean istop) {
        if (istop&& !mIsRefreshing && !mIsLoadingMore
