...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static  int JC_TYPE=0;
    public static  int JC_DEFAUT_TYPE=0;
    public static  int IS_PINHUO_MAIN_LIST_TYPE=1;
    ...
    public void setUp(String url, int screen, Object... objects) {
        if (!TextUtils.isEmpty(this.url) && TextUtils.equals(this.url, url)&&JC_TYPE==JC_DEFAUT_TYPE) {
            return;
        }
        this.url = url;
