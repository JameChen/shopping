...
public class FloatTextProgressBar extends CustomProgressBar {
    ...
    private void init(AttributeSet attrs) {
        ...
        fillColor = a.getColor(R.styleable.floatTextProgressBar_fillColor_c, 0xffff0000);
        triangleColor = a.getColor(R.styleable.floatTextProgressBar_triangleColor_c, 0xffff0000);
        rectColor = a.getColor(R.styleable.floatTextProgressBar_rectColor_c, 0xffff0000);
        a.recycle();
    }
