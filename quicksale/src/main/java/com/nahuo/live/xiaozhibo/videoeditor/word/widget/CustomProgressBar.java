...
public class CustomProgressBar extends AbsProgressBar {
    ...
    private void init(AttributeSet attrs) {
        ...
        startFillColor = a.getColor(R.styleable.progressBar_c_startFillColor_c, 0xffff0000);
        middleFillColor = a.getColor(R.styleable.progressBar_c_middleFillColor_c, 0xffff0000);
        endFillColor = a.getColor(R.styleable.progressBar_c_endFillColor_c, 0xffff0000);
        arrowPointColor = a.getColor(R.styleable.progressBar_c_arrowPointColor_c, 0xffffffff);
        a.recycle();
    }
