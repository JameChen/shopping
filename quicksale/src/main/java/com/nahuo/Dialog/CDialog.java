...
public class CDialog extends PopupWindow implements View.OnClickListener {
    ...
    public CDialog setHasTittle(boolean hasTittle) {
    ...
    public CDialog(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.praise_light_popwindow_dialog1 , null);
    ...
    public CDialog setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public CDialog setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public CDialog setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public CDialog setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public CDialog setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public CDialog setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public CDialog setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public CDialog setPositive(int resId, PopDialogListener listener) {
