...
public class CDialog2 extends PopupWindow implements View.OnClickListener {
    ...
    public CDialog2 setHasTittle(boolean hasTittle) {
        isHasTittle = hasTittle;
        return this;
    }

    public CDialog2(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public CDialog2(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    public CDialog2 setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public CDialog2 setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public CDialog2 setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public CDialog2 setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public CDialog2 setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public CDialog2 setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public CDialog2 setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog2 setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog2 setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public CDialog2 setPositive(int resId, PopDialogListener listener) {
