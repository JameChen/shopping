...
public class SingleDomDialog extends PopupWindow implements View.OnClickListener {
    ...
    public SingleDomDialog(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public SingleDomDialog(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.light_popwindow_dialog3, null);
    ...
    public SingleDomDialog setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public SingleDomDialog setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public SingleDomDialog setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public SingleDomDialog setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public SingleDomDialog setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public SingleDomDialog setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public SingleDomDialog setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public SingleDomDialog setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public SingleDomDialog setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public SingleDomDialog setPositive(int resId, PopDialogListener listener) {
