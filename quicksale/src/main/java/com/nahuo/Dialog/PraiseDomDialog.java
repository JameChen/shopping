...
public class PraiseDomDialog extends PopupWindow implements View.OnClickListener {
    ...
    public PraiseDomDialog(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public PraiseDomDialog(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.praise_light_popwindow_dialog , null);
        ...
        mBtnOK.setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.red_left));
        mBtnOK.setTextColor(mActivity.getResources().getColor(R.color.white));
        mBtnCancel.setBackgroundResource(R.drawable.white_right);
        mBtnCancel.setTextColor(mActivity.getResources().getColor(R.color.black));
        mBtnCancel.setOnClickListener(this);
        mBtnOK.setOnClickListener(this);
        mBtnOK.setText("给好评");
        mBtnCancel.setText("不满意");
    ...
    public PraiseDomDialog setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public PraiseDomDialog setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public PraiseDomDialog setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public PraiseDomDialog setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public PraiseDomDialog setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public PraiseDomDialog setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public PraiseDomDialog setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public PraiseDomDialog setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public PraiseDomDialog setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public PraiseDomDialog setPositive(int resId, PopDialogListener listener) {
