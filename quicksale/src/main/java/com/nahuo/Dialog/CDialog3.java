...
public class CDialog3 extends PopupWindow implements View.OnClickListener {
    ...
    public CDialog3 setHasTittle(boolean hasTittle) {
        isHasTittle = hasTittle;
        return this;
    }

    public CDialog3(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public CDialog3(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.praise_light_popwindow_dialog3 , null);
    ...
    public CDialog3 setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public CDialog3 setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public CDialog3 setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public CDialog3 setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public CDialog3 setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public CDialog3 setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public CDialog3 setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog3 setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public CDialog3 setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public CDialog3 setPositive(int resId, PopDialogListener listener) {
