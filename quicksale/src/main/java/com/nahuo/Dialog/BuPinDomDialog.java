...
public class BuPinDomDialog extends PopupWindow implements View.OnClickListener {
    ...
    public BuPinDomDialog(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public BuPinDomDialog(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.bu_light_popwindow_dialog, null);
    ...
    public BuPinDomDialog setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public BuPinDomDialog setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public BuPinDomDialog setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public BuPinDomDialog setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public BuPinDomDialog setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public BuPinDomDialog setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public BuPinDomDialog setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public BuPinDomDialog setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public BuPinDomDialog setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public BuPinDomDialog setPositive(int resId, PopDialogListener listener) {
