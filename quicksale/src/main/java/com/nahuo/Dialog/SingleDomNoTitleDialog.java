...
public class SingleDomNoTitleDialog extends PopupWindow implements View.OnClickListener {
    ...
    public SingleDomNoTitleDialog(Activity activity) {
        super();
        this.mActivity = activity;
        initViews();
    }

    public SingleDomNoTitleDialog(Activity activity, AttributeSet atrr) {
        super();
        this.mActivity = activity;
        initViews();
    }
    ...
    private void initViews() {
        mRootView = mActivity.getLayoutInflater().inflate(R.layout.light_popwindow_dialog4, null);
    ...
    public SingleDomNoTitleDialog setTitle(CharSequence title) {
        mTvTitle.setText(title);
        return this;
    }

    public SingleDomNoTitleDialog setTitle(int resId) {
        mTvTitle.setText(resId);
        return this;
    }

    public SingleDomNoTitleDialog setIcon(int resId) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public SingleDomNoTitleDialog setIcon(Drawable icon) {
        mTvTitle.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        return this;
    }

    public SingleDomNoTitleDialog setMessage(CharSequence message) {
        mTvMessage.setText(message);
        return this;
    }

    public SingleDomNoTitleDialog setMessage(int resId) {
        mTvMessage.setText(resId);
        return this;
    }

    public SingleDomNoTitleDialog setNegative(CharSequence text, PopDialogListener listener) {
        mBtnCancel.setText(text);
        mNegativePopDialogListener = listener;
        return this;
    }

    public SingleDomNoTitleDialog setNegative(int resId, PopDialogListener listener) {
        mBtnCancel.setText(resId);
        mNegativePopDialogListener = listener;
        return this;
    }

    public SingleDomNoTitleDialog setPositive(CharSequence text, PopDialogListener listener) {
        mBtnOK.setText(text);
        mPositivePopDialogListener = listener;
        return this;
    }

    public SingleDomNoTitleDialog setPositive(int resId, PopDialogListener listener) {
