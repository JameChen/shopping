...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public static int Type_Defaut=0;
    public static int Type_Out_ArcLayout=1;
    private int Type=Type_Defaut;
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (Type==Type_Out_ArcLayout) {
                ArcLayout arcLayout = new ArcLayout(context, false, 30);
                //arcLayout.setElevation(10);
                arcLayout.addView(imageView);
                imageViews.add(arcLayout);
            }else {
...
//            View arcView = inflater.inflate(R.layout.arc_layout,container,false);
//            ImageView iv= (ImageView) arcView.findViewById(R.id.image_view);
//            container.addView(arcView);
