...
public class ArcLayout extends FrameLayout {
    ...
    public ArcLayout(Context context,boolean cropInside,float arcHeight ) {
        super(context);
        init(context, null, cropInside, arcHeight);
    }
    ...
    public void init(Context context, AttributeSet attrs,boolean cropInside,float arcHeight) {
        settings = new ArcLayoutSettings(context, attrs);
        settings.setElevation(ViewCompat.getElevation(this));
        settings.setCropInside(cropInside);
        settings.setArcHeight(arcHeight);
        /**
         * If hardware acceleration is on (default from API 14), clipPath worked correctly
         * from API 18.
         *
